    ...
    public function getcategoriesList(Request $request)
    {
        ...
        return \Yajra\DataTables\DataTables::of($data)
            ...
            ->addColumn('Actions', function ($data) {
                ...
                <li class="nk-tb-action-hidden">
                    <a href="' . route('categories.delete', $data->id) . '" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Supprimer">
                    ...
                    <div class="drodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <ul class="link-list-opt no-bdr">
                                ...
                                <li><a href="' . route('categories.delete', $data->id) . '" ><em class="icon ni ni-trash"></em><span>Supprimer</span></a></li>
                            </ul>
                        </div>
                    </div>
                </li>
