									...
									<form method="POST" class="form-validate" action="{{ route('password.update') }}">
										...
										<div class="form-group">
											...
											<input class="form-control form-control-lg" id="email" type="email" name="email"
												value="{{ old('email', $request->email) }}" required autofocus placeholder="@lang('Entrer votre mot de passe')">
										</div>
										<div class="form-group">
											<div class="form-label-group">
											...
											<input class="form-control form-control-lg" id="password" type="password" name="password" required
												autocomplete="new-password" placeholder="@lang('Entrer votre mot de passe')">
										</div>
										<div class="form-group">
											<div class="form-label-group">
											...
											<input class="form-control form-control-lg" id="password_confirmation" type="password"
												name="password_confirmation" required autocomplete="new-password" placeholder="@lang('Confirmer votre mot de passe')">
										</div>
										<div class="form-group">
