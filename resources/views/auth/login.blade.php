									...
									<form method="POST" class="form-validate" action="{{ route('login') }}">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control form-control-lg" required id="email"
												placeholder="@lang('Entrer votre email')" name="email" :value="old('email')" required autofocus>
										</div>
										<div class="form-group">
											<div class="form-label-group">
											...
											<div class="form-control-wrap">
												...
												<input type="password" name="password" autocomplete="current-password" class="form-control form-control-lg"
													id="password" placeholder="@lang('Entrer votre mot de passe')" required>
											</div>
										</div>
										<div class="mt-4 block">
										...
										<div class="form-group">
											<button type="submit" class="btn btn-lg btn-primary btn-block">@lang('Valider')</button>
										</div>
									</form>
								</div>
							</div>
