													...
													<div class="row g-gs">
														<div class="col-md-12">
															<div class="form-group">
																<input type="number" value="{{ $membre->id }}" name="id" id="id" hidden>
																<label style="font-weight: bold;" for="typePrestation">Type
																	de prestation
																	*</label>
																<div class="form-control-wrap">
																	<select class="form-control" id="typePrestation" name="typePrestation">
																		@isset($type_prestation)
																			<option value="{{ $type_prestation->id . '|' . $type_prestation->montant }}">
														...
														<div class="col-md-12">
															<div class="form-group">
																<x-input name='montant' :value="isset($prestation) ? floatval($prestation->montant) : ''" input='number' :required="true" :disabled="true"
																	title="Montant * (FCFA)">
																</x-input>
															</div>
														</div>
														<div class="col-md-12">
															<div class="form-group">
																<x-input name='date' :value="isset($prestation)
																    ? date('Y-m-d', strtotime($prestation->date))
																    : Carbon\Carbon::now()->format('Y-m-d')" input='date' :required="true" title="Date *">
																</x-input>
															</div>
														</div>
														<div class="col-md-12">
															<div class="form-group">
																<label style="font-weight: bold;" for="listAyantDroit">
																	...
																	droit *</label>
																<div class="form-control-wrap">
																	<select class="form-control" id="listAyantDroit" name="listAyantDroit">
																		@isset($ayant_droit)
														...
														<div class="col-md-12">
															<div class="form-group">
																<button type="submit" class="btn btn-lg btn-primary btn-submit-prestation">Sauvegarder</button>
