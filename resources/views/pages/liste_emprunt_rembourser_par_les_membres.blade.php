	...
	<script>
		$(document).ready(function() {
			$('#historiqueEmpruntBL').DataTable({
				...
				ajax: "{{ route('emprunt.getHistoriqueBLAllEmpruntAjax') }}",
				order: [
					[0, "desc"]
				],
				columns: [{
		...
		$('#historiqueEmpruntBLI').DataTable({
			...
			ajax: "{{ route('emprunt.getHistoriqueBLIAllEmpruntAjax') }}",
			order: [
				[0, "desc"]
			],
			columns: [{
		...
		$('#historiqueEmpruntBBL').DataTable({
			...
			ajax: "{{ route('emprunt.getHistoriqueBBLAllEmpruntAjax') }}",
			order: [
				[0, "desc"]
			],
			columns: [{
		...
		$('#historiqueEmpruntASS').DataTable({
			...
			ajax: "{{ route('emprunt.getHistoriqueASSAllEmpruntAjax') }}",
			order: [
				[0, "desc"]
			],
			columns: [{
		...
		$('#historiqueEmpruntASG').DataTable({
			...
			ajax: "{{ route('emprunt.getHistoriqueASGAllEmpruntAjax') }}",
			order: [
				[0, "desc"]
			],
			columns: [{
