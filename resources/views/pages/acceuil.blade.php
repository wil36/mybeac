...
@if (Auth::user()->role == 'admin')
                                ...
                                <div class="card card-full">
                                    <div class="nk-ecwg nk-ecwg8 h-100">
                                        <div class="card-inner">
                                            ...
                                            <div class="pl-5 chart-label-group">
    ...
    @section('script')
        <script>
            <?php
            echo 'var tab0 = ' . json_encode(0) . ';';
            echo 'var tab1 = ' . json_encode(0) . ';';
            echo 'var tab3 = ' . json_encode(0) . ';';
            echo 'var tab4 = ' . json_encode(0) . ';';
            ?>
            var salesStatistics = {
                labels: tab0,
                dataUnit: 'People',
                                        ...
                                        <div class="col-md-4">
                                            <div class='user-card user-card-s2'>
                                                ...
                                                <div class="row user-info text-left">
                                                    ...
                                                    <div class="col-md-12">
                                                        <h5>Téléphone : <a
                                                                href="tel:{{ $membre->tel }}">{{ $membre->tel }}</a>
                                                        </h5>
                                                    </div>
                                                    <div style="margin-bottom: 40px"></div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="tabItem2">
                                                            <div class="row m-md-2">
                                                                <h3 class="text-center col-md-10">Liste des prestations
                                                                </h3>
                                                            </div>
                                                            <div class="table-responsive">
                                                        ...
                                                        <div class="tab-pane" id="tabItem3">
                                                            <div class="row m-md-2">
                                                                <h3 class="text-center col-md-10">Liste des ayant droits
                                                                </h3>
                                                            </div>
                                                            <div class="table-responsive">
                                                                <table class="nk-tb-list nk-tb-ulist" id="ayantdroitList"
                                                                    ...
                                                                    <thead>
                                                                        <tr class="nk-tb-item nk-tb-head">
                                                                            ...
                                                                            <th class="nk-tb-col"><span
                                                                                    class="sub-text">@lang('Certificat
                                                                                    de
                                                                                    vie')</span>
                                                                            </th>
                                                                        </tr>
