				...
				<div class="container-fluid">
					<div class="row justify-content-center">
						<div class="col-md-11">
							...
							<div class="col-md-2">
								<a href="{{ route('categories.create') }}" class="btn btn-primary"><em class="icon ni ni-plus"></em></a>
								<a class="btn btn-primary" href="{{ route('categorie.impressionListCategorie') }}"><em
												...
												<table class="nk-tb-list nk-tb-ulist" id="userList" data-auto-responsive="false">
													<thead>
														<tr class="nk-tb-item nk-tb-head">
															...
															<th class="nk-tb-col"><span class="sub-text">@lang('Code')</span>
															</th>
															<th class="nk-tb-col"><span class="sub-text">@lang('Libelle')</span>
															</th>
