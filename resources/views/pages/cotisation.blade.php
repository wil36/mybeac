									...
									<div class="card card-preview">
										<div class="card-inner">
											<div class="row">
												...
												<div class="col-md-3" style="margin-bottom: 10px">
													<x-input name='num_seance1' :value="$numero_seance" input='text' :required="true" title="Numéro de la séance"
														:disabled="true">
													</x-input>
												</div>
												<div class="col-md-3" style="margin-bottom: 10px">
									...
									<div class="card card-preview">
										<div class="card-inner">
											<div class="row">
												...
												<div class="col-md-3" style="margin-bottom: 10px">
													<x-input name='num_seance2' :value="$numero_seance" input='text' :required="true" title="Numéro de la séance"
														:disabled="true">
													</x-input>
												</div>
												<div class="col-md-3" style="margin-bottom: 10px">
