									...
									<div class="col-md-4">
										<div class='user-card user-card-s2'>
											...
											<div class="row user-info text-left">
												...
												<div class="col-md-12">
													<h5>Poids du membre :
														<span style="color: {{ $poidMembre < 0 ? 'red' : '#c7932b' }};">{{ $poidMembre2 }}
															FCFA</span>
													</h5>
												</div>
											</div>
												...
												<div class="tab-content">
													...
													<div class="tab-pane" id="tabItem2">
														<div class="row m-md-2">
															<div class="col-md-2">
																<a href="{{ route('prestation.create', $membre->id) }}" class="btn btn-primary"><em
																		class="icon ni ni-plus"></em></a>
															</div>
															<h3 class="col-md-10 text-center">Liste des prestations</h3>
														</div>
														<div class="table-responsive">
													...
													<div class="tab-pane" id="tabItem3">
														<div class="row m-md-2">
															<div class="col-md-2">
																<a href="{{ route('ayantsdroits.create', $membre->id) }}" class="btn btn-primary"><em
																		class="icon ni ni-plus"></em></a>
															</div>
