...
<head>
	<meta charset="utf-8" />
	<title>Liste des membres historique cotisation mensuel</title>
	<style>
		body {
			max-width: 800px;
			margin: 0 auto;
...
<body
  ...
  margin-right: auto;">
	...
	<div id="content">
		...
		<div class="obj">
			<h1 style="text-align: center;"><b>Cotisation de :
					{{ isset($tabDate[1]) && isset($tabDate[0]) ? DateTime::createFromFormat('Y-m', $dateDeRecherche)->format('M Y') : 'La date est du mauvais format' }}</b>
			</h1>
			<br />
		</div>
				...
				<table class="nk-tb-list nk-tb-ulist table-bordered" id="userList" data-auto-responsive="false"
					...
					<thead>
						<tr class="nk-tb-item nk-tb-head">
							...
							<th class="nk-tb-col"><span class="sub-text">@lang('Nom & Prenom')</span>
							</th>
					...
					<tbody style="text-align: center;">
						@foreach ($membres as $membre)
							<tr>
								...
								<td>{{ number_format($membre->montant, 0, ',', ' ') . ' FCFA' }}</td>
							</tr>
						@endforeach

						<tr>
							<td></td>
							<td><b><br>TOTAL <br><br></b></td>
							<td></td>
							<td><b>{{ number_format($montant_global, 0, ',', ' ') . ' FCFA' }}</b></td>
						</tr>
					</tbody>
				</table>
			</div>
