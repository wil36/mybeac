...
<head>
	<meta charset="utf-8" />
	<title>Liste des emprunts Avance sur Gratification</title>
	<style>
		body {
			max-width: 800px;
			margin: 0 auto;
...
<body
  ...
  margin-right: auto;">
	...
	<div id="content">
		...
		<br><br>
		<div class="obj">
			<h1 style="text-align: center;"><b>Liste des emprunts Avance sur Gratification</b></h1>
			<br />
		</div>
				...
				<table class="nk-tb-list nk-tb-ulist table-bordered" id="userList" data-auto-responsive="false"
					...
					<tbody style="text-align: center;">
						@foreach ($datas as $data)
							<tr>
								<td>{{ $data->membre->nom }} {{ $data->membre->prenom }}</td>
								<td>
									{{ $data->type == 'BLI' ? 'Bridge Loan Immo' : ($data->type == 'BBL' ? 'Back to Back Loan' : ($data->type == 'ASS' ? 'Avance Sur Salaire' : ($data->type == 'BL' ? 'Bridge Loan' : ($data->type == 'ASG' ? 'Avance Sur Gratification' : '')))) }}
								</td>
