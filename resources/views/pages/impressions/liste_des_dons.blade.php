...
<head>
	<meta charset="utf-8" />
	<title>Liste des dons de la mutuelle</title>
	<style>
		body {
			max-width: 800px;
			margin: 0 auto;
...
<body
  ...
  margin-right: auto;">
	...
	<div id="content">
		...
		<br><br>
		<div class="obj">
			<h1 style="text-align: center;"><b>Liste des dons de la mutuelle</b></h1>
			<br />
		</div>
				...
				<table class="nk-tb-list nk-tb-ulist table-bordered" id="userList" data-auto-responsive="false"
					...
					<thead>
						<tr class="nk-tb-item nk-tb-head">
							<th class="nk-tb-col"><span class="sub-text">@lang('Type')</span>
							</th>
					...
					<tbody style="text-align: center;">
						@foreach ($dons as $don)
							<tr>
								...
								<td>{{ $don->sexe }}</td>
								<td>{{ $don->email }}</td>
								<td>{{ Carbon\Carbon::parse($don->date)->format('d M Y') }}</td>
