...
<body
  ...
  margin-right: auto;">
	...
	<div id="content">
		...
		<br><br>
		<div class="obj">
			<h1 style="text-align: center;"><b>Liste des prestations</b></h1>
			<br />
		</div>
				...
				<table class="nk-tb-list nk-tb-ulist table-bordered" id="userList" data-auto-responsive="false"
					...
					<thead>
						<tr class="nk-tb-item nk-tb-head">
							...
							<th class="nk-tb-col"><span class="sub-text">@lang('Type de prestation')</span>
							</th>
							<th class="nk-tb-col"><span class="sub-text">@lang('Ayant droit')</span>
							</th>
						</tr>
					</thead>
					...
					<tbody style="text-align: center;">
						@foreach ($datas as $data)
							<tr>
								<td>{{ Carbon\Carbon::parse($data->dates)->format('d M Y') }}</td>
