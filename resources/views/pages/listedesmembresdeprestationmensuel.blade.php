												...
												<table class="nk-tb-list nk-tb-ulist" id="userList" data-auto-responsive="false">
													<thead>
														<tr class="nk-tb-item nk-tb-head">
															...
															<th class="nk-tb-col"><span class="sub-text">@lang('Montant total des prestations')</span>
															</th>
	...
	<script>
	 $(document).ready(function() {
	  $('#userList').DataTable({
	   ...
	   ajax: "{{ route('prestation.getUserDetailPrestationHistoriqueMensuel', $dateDeRecherche) }}",
	   order: [
	    [0, "desc"]
	   ],
	   columns: [{
