				...
				<div class="container-fluid">
					<div class="row justify-content-center">
						<div class="col-md-11">
							...
							<div class="col-md-2">
								<a href="{{ route('typeprestation.create') }}" class="btn btn-primary"><em class="icon ni ni-plus"></em></a>
								<a class="btn btn-primary" href="{{ route('TypePrestation.impressionListTypePrestation') }}"><em
