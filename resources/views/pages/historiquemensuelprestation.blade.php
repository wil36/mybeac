				...
				<div class="container-fluid">
					<div class="row justify-content-center">
						<div class="col-md-11" style="margin-top: 80px">
							...
							<a class="btn btn-primary" href="{{ route('prestation.impressionListHistoriqueMensuelPrestation') }}"><em
									...
									<div class="card card-preview">
										<div class="card-inner">
											<div class="table-responsive">
												<table class="nk-tb-list nk-tb-ulist" id="cotisationListHistoriqueMensuel" data-auto-responsive="false">
													<thead>
														<tr class="nk-tb-item nk-tb-head">
															<th class="nk-tb-col"><span class="sub-text">@lang('Année')</span>
															</th>
															<th class="nk-tb-col"><span class="sub-text">@lang('Mois')</span>
															</th>
	...
	<script>
		$(document).ready(function() {
			$('#cotisationListHistoriqueMensuel').DataTable({
				...
				ajax: "{{ route('prestation.historique.mensuel') }}",
				order: [
					[0, "desc"]
				],
				columns: [{
