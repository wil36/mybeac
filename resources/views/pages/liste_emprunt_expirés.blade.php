				...
				<div class="container-fluid">
					<div class="row justify-content-center">
						<div class="col-md-11">
							...
							<a class="btn btn-primary" href="{{ route('emprunt.impressionListDesEmpruntsExpires') }}"><em
									...
									<div class="card card-preview">
										<div class="card-inner">
											<div class="table-responsive">
												<table class="nk-tb-list nk-tb-ulist" id="empruntExpireList" data-auto-responsive="true">
													<thead>
	...
	<script>
		$(document).ready(function() {
			$('#empruntExpireList').DataTable({
				...
				ajax: "{{ route('emprunt.getListOfEmpruntWhoIsExpireAjax') }}",
				order: [
					[0, "desc"]
				],
				columns: [{
