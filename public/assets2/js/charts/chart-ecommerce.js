...
! function(NioApp, $) {
    ...
    var salesStatistics = {
        ...
        datasets: [{
            ...
            dash: [5],
            background: "transparent",
            data: [1400, 220, 810, 480, 600, 670, 660, 830, 590, 730, 790, 950, 100, 800, 950, 850, 950, 450, 900, 0, 200, 250, 900, 950, 300, 200, 250, 650, 950, 750]
        }, {
            label: "Canceled orders",
            color: "#74211A",
            dash: [5],
            background: "transparent",
            data: [110, 220, 810, 480, 4300, 670, 660, 830, 590, 730, 790, 950, 100, 800, 950, 850, 950, 450, 900, 0, 200, 250, 900, 950, 300, 200, 250, 650, 950, 750]
        }]
    };
